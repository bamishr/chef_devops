...
Installs and configures Percona's MySQL client or server or Cluster.
...
On client nodes,
    ...
    include_recipe "mysql_percona::client"
...
On server nodes,
    ...
    include_recipe "mysql_percona::server"
...
On EC2 nodes,
    ...
    include_recipe "mysql_percona::server_ec2"
