...
license           "Apache 2.0"
description       "Installs and configures percona mysql for client or server"
long_description  IO.read(File.join(File.dirname(__FILE__), 'README.md'))
version           "1.0.2"
recipe            "mysql_percona", "Includes the client recipe to configure a client"
recipe            "mysql_percona::client", "Installs packages required for mysql clients using run_action magic"
recipe            "mysql_percona::server", "Installs packages required for mysql servers w/o manual intervention"
recipe            "mysql_percona::server_ec2", "Performs EC2-specific mountpoint manipulation"
